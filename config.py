...
load_dotenv()
MARKET_VERSION = "4.1.2" # Версия проекта, возвращается на /api/health

# 🌱 НАСТРОЙКИ ЗАПОЛНЕНИЯ БАЗЫ ДАННЫХ (для seed.py)
class SeedConfig:
    """Конфигурация сидинга"""
    NUM_USERS = 20                    # Количество пользователей
    NUM_PRODUCTS = 25                 # Количество товаров (Если нужно больше, то добавить больше уникальных изображений)
